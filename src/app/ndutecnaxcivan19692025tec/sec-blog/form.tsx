...
export interface SecNewsArticle {
  id: string;
  title: string;
  slug: string;
  description: string;
...
interface SecNewsFormProps {
  onSubmit: (values: Omit<SecNewsArticle, 'id'>, imageFile: File | null) => Promise<void>;
  initialData?: SecNewsArticle | null;
  onClose: () => void;
}

export function SecNewsForm({ onSubmit, initialData, onClose }: SecNewsFormProps) {
  ...
  const handleSubmit = async (values: FormValues) => {
    ...
    try {
        await onSubmit(values as Omit<SecNewsArticle, 'id'>, imageFile);
        form.reset();
        onClose();
    } catch (error: any) {
        toast({
