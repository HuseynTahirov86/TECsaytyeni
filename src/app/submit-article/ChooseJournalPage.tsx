...
import { FileText, BookOpen, Landmark } from 'lucide-react';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import Link from 'next/link';
import { Button } from '@/components/ui/button';
import { motion } from 'framer-motion';

export default function ChooseJournalPage() {
    ...
    >
      ...
      >
        ...
        <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
          Məqalənizi hansı jurnala təqdim etmək istədiyinizi seçin.
        </p>
      </motion.header>
        ...
        <motion.div variants={FADE_IN_ANIMATION_SETTINGS}>
            <Card className="flex flex-col items-center justify-center p-8 text-center hover:shadow-lg transition-shadow h-full">
                <CardHeader>
                    ...
                    <CardDescription>Ümumi elmi və tədqiqat məqalələri üçün.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Button asChild>
                        <Link href="/submit-article/science">Məqalə Göndər</Link>
                    </Button>
                </CardContent>
            </Card>
        </motion.div>
        <motion.div variants={FADE_IN_ANIMATION_SETTINGS}>
            <Card className="flex flex-col items-center justify-center p-8 text-center hover:shadow-lg transition-shadow h-full">
                <CardHeader>
                    ...
                    <CardDescription>Hüquq sahəsinə aid tədqiqatlar və məqalələr üçün.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Button asChild>
                        <Link href="/submit-article/law">Məqalə Göndər</Link>
                    </Button>
                </CardContent>
            </Card>
        </motion.div>
