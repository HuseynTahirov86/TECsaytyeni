...
export default function SubmitScienceArticleClientPage() {
  ...
  return (
    <motion.div 
      ...
      style={{ backgroundImage: "url('/tecjurnal.jpeg')" }}
      initial="initial"
      animate="animate"
      variants={{
        initial: { opacity: 0 },
      ...
      >
        <header className="text-center mb-8 bg-black/20 p-6 rounded-lg">
          <h1 className="text-3xl font-extrabold tracking-tight text-white lg:text-4xl">
            TƏLƏBƏ ELMİ JURNALININ İLK BURAXILIŞINA MƏQALƏ QƏBULU
          </h1>
          <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-200">
            Elmi fikirlərinizi, tədqiqatlarınızı və ya kəşflərinizi TEC icması ilə paylaşın.
          </p>
        </header>
        <div className="p-4 sm:p-8 border border-gray-700 rounded-lg bg-card/80 text-card-foreground shadow-lg backdrop-blur-md">
          <ArticleForm journalType="science" />
        </div>
      </motion.div>
    </motion.div>
  );
