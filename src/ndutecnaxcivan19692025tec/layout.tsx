...
import { Home, Newspaper, Briefcase, LogOut, Share2, Users, MessageSquare, BookText, Landmark, MailCheck, UserCheck, Library, GraduationCap, ClipboardList, Quote, Building, Archive, Bot } from "lucide-react";
...
const navLinks = [
  ...
  { href: "/ndutecnaxcivan19692025tec/teti-reports", label: "TETİ Siyahıları", icon: Building },
